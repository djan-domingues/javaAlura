...
public class TestaMetodo {
	...
	public static void main(String[] args) {
		...
		/*
		 * Aqui estamos sincretizando duas coisas, como o método saca é um metodo que emite um boolean quando chamado, estamos definindo uma variavel
		 * para receber esse boolean, a variavel conseguiuSacar ira receber o boolean do método saca descrito
		 * 
		 * após um sysout para verificarmos tanto a variavel booleana quanto o saldo apos o metodo
		 */
		 ...
		 * 
		 * depois utilizamos a mesma sincretização de definir uma variavel pra receber o boolean do metodo trasnfere e definimos que a contaDaMarcela
		 * fara o metodo trasnfere, definimos o valor e a conta
		 * 
		 * depois visualizamos os saldos de ambos para ver a mudança e a variavel booleana do metodo
		 */
		...
		/*
		 * Como o método emite um valor booleano poderiamos utiliza-lo sem nem guarda-lo numa variavel, apenas o utilizando num if:
		 * 
